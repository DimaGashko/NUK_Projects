...
const parseEquation = (function () {
   ...
   function parseEquation(e) {
      for (var n, x, o = [], s = [x = RPN(e.replace(/ /g, "").split(""))]; s.length;)
         for ((n = s[s.length - 1], --s.length); n[2]; o[o.length] = n, s[s.length] = n[3], n = n[2]);
      for (; (n = o.pop()) != undefined; n[0] = o[n[0]](isNaN(n[2][0]) ? f(n[2][0]) : n[2][0], isNaN(n[3][0]) ? f(n[3][0]) : n[3][0]));
      return +x[0];
   };
